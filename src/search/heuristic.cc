...
EvaluationResult Heuristic::compute_result(StateEvaluationContext &eval_context) {
...
EvaluationResult Heuristic::compute_result(EdgeEvaluationContext &eval_context) {
    EvaluationResult result;
